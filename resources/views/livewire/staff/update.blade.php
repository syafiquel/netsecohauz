    ...
    <form>
        ...
        <div class="row">
            <div class="form-group col-6">
                ...
                <input id="first_name" type="text" class="form-control" name="first_name" autofocus wire:model="first_name">
            </div>
            <div class="form-group col-6">
                <label for="last_name">Last Name</label>
                <input id="last_name" type="text" class="form-control" name="last_name" wire:model="last_name">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <label>Department</label>
                <select wire:model="department" class="form-control selectric">
                    ...
                    <option selected value="{{ $department }}">{{ ucfirst($department) }}</option>
                    @else
