<x-app-layout>
    ...
    <x-slot name="header">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item active"><a href="#">Batch Palette</a></div>
            </div>
        </div>
    </x-slot>
    ...
    <div class="card-body p-0">
        ...
        <x-slot name="card_header">
            <x-button-card-header data-target="#modal-add-batch-palette-part">Add</x-button-card-header>
        </x-slot>

        @livewire('flash-message')

        <livewire:palette.datatable />
